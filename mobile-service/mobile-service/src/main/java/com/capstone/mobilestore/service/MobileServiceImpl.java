...
//		 Mobile mobile = mobileRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Mobile not found"));
		 
		 
//         mobile.setMobileName(mobileDetails);
//         mobile.setMobileCost(mobileDetails.getMobileCost());
//         mobile.setMfd(mobileDetails.getMfd());
//         mobile.setModelNumber(mobileDetails.getModelNumber());
//         mobile.setCategory(mobileDetails.getCategory());
//         mobile.setCompanyName(mobileRequest.getCompanyName());
//         return mobileRepository.save(mobile);
